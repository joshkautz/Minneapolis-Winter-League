...
import { currentPlayerRankingsQuery } from '@/firebase/collections/hallOfFame'
		...
		<div className='container mx-auto px-4 py-8 space-y-6'>
			...
			<div className='text-center space-y-4'>
				...
				<p className='text-muted-foreground max-w-2xl mx-auto'>
					Player rankings based on performance across all seasons. Rankings
					consider point differentials, opponent strength, playoff performance,
					and recent activity.
				</p>
			</div>
